...
welcomeMusic.volume = 0.5; // Set volume to 50%
...
function startGame() {
    ...
    let welcomeMusic = document.getElementById("welcome-music");
    welcomeMusic.pause(); // Pauses the welcome music
    welcomeMusic.currentTime = 0; // Resets the audio to the start in case you want to play it again later
    ...
    // Setup the internal structures with the correct values
    ...
    // Show the game board and hide the welcome screen
...
function restart() {
    ...
    playerIterator = undefined; // Clear the pointers

    // Restart the welcome music
    let welcomeMusic = document.getElementById("welcome-music");
    welcomeMusic.play(); // Play welcome music again when game restarts
}
...
function movePlayer(player) {
    ...
    moveSound.volume = 0.8; // Set the volume if needed
...
// to increase the dynamically size of the input tags
document.getElementById("start").style.fontSize = "18px";
document.getElementById("start").style.width = "200px";

document.getElementById("number").style.fontSize = "18px";
document.getElementById("number").style.width = "150px";
